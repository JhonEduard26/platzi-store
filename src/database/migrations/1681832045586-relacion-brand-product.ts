...
export class RelacionBrandProduct1681832045586 implements MigrationInterface {
  name = 'RelacionBrandProduct1681832045586';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "brand" ADD CONSTRAINT "UQ_9ca4657c168f06af1b0131316c2" UNIQUE ("image")`,
    );
    await queryRunner.query(
      `ALTER TABLE "brand" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "brand" DROP CONSTRAINT "UQ_9ca4657c168f06af1b0131316c2"`,
    );
